...
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_ID IS '게시판_고유번호(PK)';
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_TITLE IS '게시판_제목';
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_AUTHOR IS '게시판_작성자';
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_CONTENT IS '게시판_내용';
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_CREATED IS '게시판_작성일(기본값: 현재날짜)';
COMMENT ON COLUMN FREEBANKBOARD.FREEBANKBOARD_UPDATE IS '게시판_수정일(기본값: 현재날짜)';
...
COMMENT ON COLUMN FREEBANKPURCHASELIST.FREEBANKPURCHASELIST_USERID IS '구매내역_유저아이디';
