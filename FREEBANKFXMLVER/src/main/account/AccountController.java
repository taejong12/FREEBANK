...
public class AccountController {
	...
	@FXML TableView<AccountDTO> accountTableView;
	@FXML private TableColumn<AccountDTO, String> accountAccountColumn;
    @FXML private TableColumn<AccountDTO, Integer> accountBalanceColumn;
    @FXML private TableColumn<AccountDTO, Date> accountCreateColumn;
    @FXML private TableColumn<AccountDTO, String> accountIdColumn;
	...
	public void updateAccountDeposit() {
		System.out.println("계좌입금 버튼");
		as.updateAccountDeposit(userDTO);
	}
	
	public void updateAccountWithdrawal() {
		System.out.println("계좌출금 버튼");
		as.updateAccountWithdrawal(userDTO);
	}
	
	public void deleteAccount() {
		System.out.println("계좌해지 버튼");
		as.deleteAccount(userDTO);
	}
